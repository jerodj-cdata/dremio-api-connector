...
@SourceType(value = "APIARP", label = "API",uiConfig = "api-layout.json")
public class APIConf extends AbstractArpConf<APIConf> {
  private static final String ARP_FILENAME = "arp/implementation/api-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.api.APIDriver";
